...
ots = begin
	datapath = isdir("../data") ? "../data/OT" : "./data/OT"
	a = NPZ.npzread(joinpath(datapath, "a_marginal_saved.npy"))
	b = NPZ.npzread(joinpath(datapath, "b_marginal_saved.npy"))
	C = NPZ.npzread(joinpath(datapath, "cost_mat_saved.npy"))
...
begin
	@test all( (A*vec(X))[1:m] .≈ vec(sum(X, dims=2)) ) 
...
# ╔═╡ cea65061-9216-446c-8947-76833e1b4d4d
HTML("""
<!-- the wrapper span -->
<div>
